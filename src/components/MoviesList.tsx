...
const MoviesList= ({typeOfMovie, isFavourites, searchText} : Props) =>
{      
// console.log(searchText);
   let  searchResultData = [] as IMovie[];
   
    
const [ favouritesList, setFavouriteslist ] = useState<{ movie: IMovie, favourites: number }[]>( [] );
